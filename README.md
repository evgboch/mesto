# Проект: Место
---
Привет! Это мой проект "Mesto Russia", который я разработал в рамках прохождения четвертого - седьмого спринтов обучения на Яндекс.Практикуме.
...
* Макет 7 спринта отсутствует, так как задача заключалась в рефакторинге кода
